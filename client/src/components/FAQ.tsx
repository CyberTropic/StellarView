...
const FAQ = () => (
  <FAQStyle>
    ...
    <div className="FAQ_Sections_Content">
      ...
      <div className="Background">
        <span>
          Registering grants you the ability to review a park, as well as to
          save a park to your "Favourites". The Favourites section appears upon
          registering and logging in. In the future, it will be important for
          e-mail alerts/push notifications. These alerts will only be sent in
          the morning when your nearby parks are predicted to have excellent
          naked-eye star visibility. We will ask for user permission before this
      ...
      <div className="Background">
        <span>
          This section will be continously updated. We plan on: <br></br>
          <br></br>
          <ul>
            <li>
              Push notifications so users don't have to continuously check the
              website - our server will run the queries for you and then notify
            ...
            <li>
              Better login/registration system with e-mail confirmation, ability
              to change passwords, delete account, etc.
            </li>
            <li>
              More accurate weather predictions using a paid weather API
              service.
            </li>
          </ul>
        </span>
